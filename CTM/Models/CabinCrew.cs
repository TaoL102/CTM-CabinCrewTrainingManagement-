...
{
    public class CabinCrew : Model, IEquatable<CabinCrew>
    {
        public CabinCrew()
        {
        ...
        [Index(IsUnique=true)]
        [StringLength(100)]
        [Display(Name = "CabinCrewName", ResourceType = typeof(CTMLocalizationLib.Resources.ConstModels))]
        public string Name { get; set; }

        [Display(Name = "IsResigned", ResourceType = typeof(CTMLocalizationLib.Resources.ConstModels))]
