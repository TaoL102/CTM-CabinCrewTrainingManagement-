...
{
    public class RefresherTraining : Model
    {
        [Required]
        ...
        [Display(Name = "Remark", ResourceType = typeof(CTMLocalizationLib.Resources.ConstModels))]
        ...
        [DisplayFormat(DataFormatString = "{0:yyyy-MM-dd}", ApplyFormatInEditMode = true)]
        [DataType(DataType.Date)]
        [Display(Name = "ExpiryDate", ResourceType = typeof(CTMLocalizationLib.Resources.ConstModels))]
