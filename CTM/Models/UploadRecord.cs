...
{
    public class UploadRecord : Model
    {
        ...
        [Display(Name = "Description", ResourceType = typeof(CTMLocalizationLib.Resources.ConstModels))]
        public string Description { get; set; }

        [DisplayFormat(DataFormatString = "{0:yyyy-MM-dd H:mm:ss}", ApplyFormatInEditMode = true)]
        [DataType(DataType.DateTime)]
        [Display(Name = "DateTime", ResourceType = typeof(CTMLocalizationLib.Resources.ConstModels))]
        ...
        [Display(Name = "IsWithdrawn", ResourceType = typeof(CTMLocalizationLib.Resources.ConstModels))]
