...
namespace CTM.Models
{
    public class UploadRecord : Model<UploadRecord>
    {
        ...
        [Display(Name = "Description", ResourceType = typeof(Resources.Models.ConstModels))]
        public string Description { get; set; }

        [DisplayFormat(DataFormatString = "{0:yyyy-MM-dd H:mm:ss}", ApplyFormatInEditMode = true)]
        [DataType(DataType.DateTime)]
        [Display(Name = "DateTime", ResourceType = typeof(Resources.Models.ConstModels))]
        ...
        [Display(Name = "IsWithdrawn", ResourceType = typeof(Resources.Models.ConstModels))]
