// Set constants
 ...
 class ConstantHelper {
     public static LoaderId = "loader";
     public static  ProgressBarId = "alert";
     public static  FullModalId = "full_size_modal";
     public static FullModalContentId = "full_size_modal_content";
